import{c as N,o as F,f as $,g as O,e as q,r as A}from"./sanitize-CI9i0hEO.js";import{a as R,g as l,b as z,I as c,t as y,l as C,s as G,c as M}from"./icons-87ROm5CI.js";import{w as D,c as H}from"./loader-DF9fu2XM.js";async function P(i){const{roomId:m,token:E}=R();if(!m||!E){window.location.href=l()+"/index.html";return}const r=N(m);if(await r.init(),!r.getState()){window.location.href=l()+"/index.html";return}let _=!1,f=new Set;async function L(e){await D(async()=>{var d;const a=await C(e),{cells:t,startsFirst:o}=H({size:5,words:a}),g={gameId:((d=crypto.randomUUID)==null?void 0:d.call(crypto))||Math.random().toString(36).slice(2),phase:"active",size:5,cells:t,turn:{team:o,guideLimit:null,dreamwalkerMoves:0},teamEffects:M(),gameOver:!1,winner:null,turnTransition:null};await G.from("rooms").update({state:g,language:e}).eq("id",m)})}function B(e){const a=y(e);i.innerHTML=`

import{c as f,d as L,f as k,R as m}from"./revealedCells-C05Jb7QJ.js";import{t as g,d as w,D as b,b as E}from"./url-DAL9jQbt.js";import{a as y}from"./roomRepository-CD0Cuu1e.js";function G(i,n){var a;(a=i.querySelector(".turn-transition-overlay"))==null||a.addEventListener("click",()=>{n()})}function T(i){const n=g(i);let a=[];async function r(){var e;try{(e=screen.orientation)!=null&&e.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let e=document.getElementById("orientation-guard");return e||(e=document.createElement("div"),e.id="orientation-guard",e.className="orientation-guard",e.setAttribute("aria-live","polite"),e.innerHTML=`

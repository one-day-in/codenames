import{o as M,h as I,e as O,r as k,a as q,i as W}from"./syncIndicator-D2f8fAiK.js";import{t as f,D as b,n as j,b as D,I as F}from"./url-BkejxNIu.js";import{i as R,b as x}from"./initGuestPage-CpTiMpLy.js";import"./entry-E3Bxpwj9.js";const P=8;async function V(a){const h=await R(a,{roleType:"guide",invalidParamsHtml:`<div class="waiting-screen">
            <p>${f(b).scanQr}</p>
        </div>`});if(!h)return;const{presence:y,store:d,team:r}=h;let m=!1,g=new Set;function p(i=b){m=!1,g=new Set,a.innerHTML=`<div class="waiting-screen">
            <p>${f(i).waitingGame}</p>

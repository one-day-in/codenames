import{c as f,d as h,f as k,b as g}from"./turnTransitionDismiss-B0d5dzhW.js";import{t as p,d as L,D as b,b as E}from"./url-Qg2x4s1h.js";import{a as y}from"./roomRepository-DwKmHnBd.js";function T(i){const n=p(i);let r=[];function t(){const e=Math.min(window.innerWidth,window.innerHeight),s=Math.max(window.innerWidth,window.innerHeight);return window.matchMedia("(pointer: coarse)").matches&&e<=768&&s<=1024}async function c(){var e;if(t())try{(e=screen.orientation)!=null&&e.lock&&await screen.orientation.lock("portrait")}catch{}}function o(){let e=document.getElementById("orientation-guard");return e||(e=document.createElement("div"),e.id="orientation-guard",e.className="orientation-guard",e.setAttribute("aria-live","polite"),e.innerHTML=`

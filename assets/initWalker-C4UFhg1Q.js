import{g as y,e as T,r as h,a as L,b as C,o as S,h as M,i as A,j as O}from"./revealedCells-C05Jb7QJ.js";import{b as x,f as E,I as $,t as k,D as p}from"./url-DAL9jQbt.js";import{i as G,b as I}from"./initGuestPage-UxrhxSg2.js";import"./entry-Bb70VNso.js";import"./roomRepository-CD0Cuu1e.js";function B({state:e,lang:r,team:d,syncStatus:s}){const t=k(r),i=e.turn,o=i.team===d,v=i.guideLimit!==null,l=o&&v&&!e.gameOver&&!e.turnTransition,u=v?Math.max((i.guideLimit??0)-(i.dreamwalkerMoves??0),0):0,a=x(d,r),m=l?`${t.dreamwalker}: ${E(u,r)}`:`${t.dreamwalker}: ${$.eyeClosed}`;return`

import{g as L,e as x,r as C,a as M,o as S,h as A,i as O,k as E,l as G,j as B}from"./turnTransitionDismiss-B0d5dzhW.js";import{b as I,f as R,I as $,t as w,D as T}from"./url-Qg2x4s1h.js";import{i as H}from"./initGuestPage-C0EVemuj.js";import"./entry-CIKAVfaz.js";import"./roomRepository-DwKmHnBd.js";function P({state:e,lang:n,team:l}){const a=w(n),t=e.turn,c=t.team===l,d=t.guideLimit!==null,r=c&&d&&!e.gameOver&&!e.turnTransition,_=d?Math.max((t.guideLimit??0)-(t.dreamwalkerMoves??0),0):0,k=I(l,n),v=r?`${a.dreamwalker}: <span class="walker__moves-value">${R(_,n)}</span>`:`${a.dreamwalker}: ${$.eyeClosed}`;return`

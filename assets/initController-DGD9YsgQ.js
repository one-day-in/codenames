import{C as M,m as ee,e as U,r as V,a as K,g as ne,c as te,p as q,d as re,i as ie,o as oe,f as ae,n as Q,j as F,k as z,q as le,l as se}from"./turnTransitionDismiss-IJFhM0jm.js";import{t as R,e as B,I as x,f as ce,h as de,k as ue,D,n as me}from"./roomRepository-DF5mcqIV.js";import"./entry-v524_0H2.js";function ge(e){const n=R(e);let s=[];function l(){const i=Math.min(window.innerWidth,window.innerHeight),o=Math.max(window.innerWidth,window.innerHeight);return window.matchMedia("(pointer: coarse)").matches&&i<=768&&o<=1024}async function m(){var i;if(l())try{(i=screen.orientation)!=null&&i.lock&&await screen.orientation.lock("portrait")}catch{}}function d(){let i=document.getElementById("orientation-guard");return i||(i=document.createElement("div"),i.id="orientation-guard",i.className="orientation-guard",i.setAttribute("aria-live","polite"),i.innerHTML=`

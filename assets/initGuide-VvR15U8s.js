import{j as S,e as w,r as A,a as B,o as G,f as H,h as N,k}from"./revealedCells-DKwX_vYq.js";import{b as M,I as E,t as h,D as p,n as I}from"./url-BkejxNIu.js";import{i as x,b as O}from"./initGuestPage-CFH49wW5.js";import"./entry-DcrdvCjS.js";function R({state:i,lang:a,team:o,syncStatus:s,maxHintButtons:u,teamEffects:t}){const n=h(a),c=i.turn,v=c.team===o,m=c.guideLimit!==null,e=v&&!m&&!i.gameOver&&!i.turnTransition,g=t.allowTwoWordClue,d=t.forcedGuideLimit,r=t.hideEnemyColors,l=t.hideNightmare,y=M(o,a),b=e?`${n.guide}: ${n.chooseLimit}`:`${n.guide}: ${E.eyeClosed}`,T=[e&&d===1?n.guideForcedOneMove:null,e&&g?n.guideTwoWordClue:null,r?n.guideBlurActive:null,l?n.guideNightmareHidden:null].filter(Boolean),L=T.length?`<div class="guide__meta ${e?"guide__meta--active":"guide__meta--muted"}">${T.join(" • ")}</div>`:"",C=Array.from({length:u},($,f)=>{const _=f+1;return`
            <button
    ...
    `}const j=8;async function z(i){const a=await x(i,{roleType:"guide",invalidParamsHtml:`<div class="waiting-screen">
            <p>${h(p).scanQr}</p>
        </div>`});if(!a)return;const{presence:o,store:s,team:u}=a;let t=!1,n=new Set;function c(e=p){t=!1,n=new Set,i.innerHTML=`<div class="waiting-screen">
            <p>${h(e).waitingGame}</p>
